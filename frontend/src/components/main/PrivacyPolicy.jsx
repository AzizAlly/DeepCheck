...
const sections = [
  {
    title: 'Overview',
    body: 'DeepCheck is my last year project as an AI-powered platform that detects deepfakes in short videos. We prioritize user privacy while providing reliable and transparent AI-based analysis services.',
  },
  {
  ...
  },
  {
    ...
    body: 'Uploads are limited to 30 seconds per video. Each upload is processed to generate a detection result. Only anonymized data may be used to retrain or improve DeepCheck’s detection accuracy.',
  },
  {
    title: 'Your Rights',
    body: 'You can request access, correction, or deletion of your data at any time. To do so, contact us at privacy@DeepCheck.ai. We aim to respond promptly in accordance with privacy regulations.',
  },
  {
    ...
    <section className="w-full md:w-[80%] mx-auto px-4 py-12">
      ...
      <div data-aos="fade-up" className="mt-8 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-2xl shadow-md p-6 md:p-8">
        ...
        <p className="text-gray-700 dark:text-gray-300 text-sm md:text-base">
          ...
          <a href="mailto:alyyaziz45@gmail.com" className="text-blue-600">
            alyyaziz45@gmail.com
          </a>
