...
const points = [
  'DeepCheck is an AI-powered deepfake detection tool built to identify manipulated or synthetic media in seconds.',
      ...
      <div>
        <div data-aos="fade-out" className="bg-white dark:bg-gray-800 shadow-md rounded-lg pt-10 pb-8 text-center px-5">
          <p className="text-lg md:text-xl font-medium text-gray-700 dark:text-gray-300 mb-2">
            DeepCheck as my university project empowers individuals, journalists, and organizations to verify the authenticity of digital media in an age of misinformation.
          </p>
          <p className="text-sm md:text-base text-gray-700 dark:text-gray-300">
            Using an AI model inspired by <strong>XceptionNet</strong> and <strong>GRU</strong> architectures, DeepCheck captures both spatial and temporal cues from video sequences to detect deepfakes with high precision.
          </p>
        </div>
        ...
        <div data-aos="fade-in" className="text-sm md:text-base text-gray-700 dark:text-gray-300">
          <p>
            <strong>How it works:</strong> DeepCheck extracts key frames from your video, processes them through a
          ...
          <p className="mt-2">
            ...
            <a href="alyyaziz45@gmail.com" className="text-blue-500">
