...
const faqs = [
  {
    q: 'What is DeepCheck?',
    a: 'DeepCheck is my Last year project as an AI-based tool that detects whether a video has been digitally manipulated or created using deepfake techniques. It uses a hybrid deep learning model built with XceptionNet and GRU layers for temporal consistency analysis.',
  },
  {
  ...
  },
  {
    ...
    a: 'Yes. If you wish to remove your uploaded content or metadata, please contact our team at contact@DeepCheck.ai. We comply with standard data removal and privacy guidelines.',
  },
]
