    ...
    >
      <div data-aos="fade-up" className="container mx-auto max-w-5xl px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-6">
          {/* About Section */}
          <div>
            <h3 className={`text-lg font-bold mb-3 text-purple-500`}>DeepCheck</h3>
            <p className="text-sm leading-relaxed">DeepCheck helps you check whether a video may have been manipulated. Detection is probabilistic and not 100% accurate - use results as guidance, not definitive proof.</p>
          </div>
          ...
          <div>
            ...
            <div className="flex gap-4">
              <a
                href="https://github.com/AzizAlly/DeepCheck"
                target="_blank"
        ...
        <div className={`pt-6 border-t text-sm md:text-base text-center border-gray-700`}>
          <p className="flex items-center justify-center gap-1 flex-wrap">
            ...
            by
            <a
              href="https://github.com/AzizAlly"
              target="_blank"
              rel="noopener noreferrer"
          ...
          <p className="mt-2 text-xs md:text-sm opacity-75">Supervized by Mr.Hassan.</p>
          <p className="mt-2 text-xs md:text-sm opacity-75">KIUT.</p>
        </div>
      </div>
    </footer>
  );
